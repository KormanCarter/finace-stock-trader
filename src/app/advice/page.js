                ...
                <section className="m-0 p-0 w-screen space-y-6">
                    <header className="px-6 pt-6 pb-2 space-y-2">
                        ...
                        <div className="flex gap-3">
                            ...
                            <Link
                                href="/budget?edit=true&step=tracker&returnTo=/advice"
                                className="inline-flex items-center rounded-md bg-emerald-50 px-4 py-2 text-sm font-semibold text-emerald-600 hover:bg-emerald-100 hover:bg-emerald-700 transition"
                            >
                                Edit Budget
                            </Link>
                        </div>
